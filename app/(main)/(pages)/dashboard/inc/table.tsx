          ...
          {loading ? (
            Array(5)
              ...
              .map((_, idx) => (
                <div
                  key={idx}
                  className="p-4 mb-2 border rounded-md w-[300px] bg-gray-100 animate-pulse"
                >
          ...
          {selectedBill ? (
            ...
            <div className="flex flex-col justify-center items-center h-full">
              ...
              >
                ...
                <span className="text-lg font-medium text-white break-words overflow-x-auto min-w-[500px]"></span>
              </div>
              <p className="text-gray-500 text-center">
                Select an order to view its details.
              </p>
